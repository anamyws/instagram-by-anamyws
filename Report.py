...
nu = 0
n = 0
br = pyfiglet.figlet_format("Mazen")
print(Y+br)
print(R+'''
 
 
 انستغرام : _1nxp1 حساب عليه 39K
...
''')
print(B+"سجل الدخول بحساب وهمي :")
print('\n')     
username = input("UsErNaMe :")
password = input("PaSsWoRd :")
Target = input("يوزر الضحية بدون @    :")
...
if  'authenticated":true' in r.text or 'userId' in r.text:
    ...
    try:
    	...
    	exit()
    print(R+"""
إختر نوع الإبلاغات التي تريد إرسالها للضحية :	
[1] - s سبام
[2] - v عنف
[3] - S اباحي
[4] - h مضايقة 
...
[6] - h كراهية
    ...
    xx = int(input("أدخل رقم الإبلاغات التي تريدها :"))
    print('_'*30)
    print("")
    if xx == 1:
    	P1= int(input(Y+"ادخل عدد البلاغات :"))
    	tu = int(input("الوقت بين البلاغات يفضل اختيار 10 :"))
    	print('-'*30)
    	for i_1 in range(P1):
    		...
    		if '"status":"ok"' in report_1.text:
    			...
    			n += 1
    		print(G+f"\rتم الارسال  = {nu}  {R}خطاء  ={n}",end="")
    		time.sleep(tu)
